...
Skill drafts and the owned-skill list now use five original 256px archetype icons for Packet, Hammer, Firewall, Viral, and Rage. Remaining archetypes keep readable vector icons while their art is produced. Draft cards enter with a short stagger and the art lifts on hover or keyboard focus; the reduced-motion setting and system preference suppress these motions.
