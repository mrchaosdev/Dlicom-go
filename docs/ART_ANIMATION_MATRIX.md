...
Spam Bot has an original vector placeholder. Scam Link, Bug and Raid Bot still use tinted versions of it. The four bosses have distinct original vector silhouettes, but they remain replaceable placeholders. Existing enemies have idle breathing, attack lunge, hurt reaction and defeat fade; final character-specific poses and production art are still open.

## Remaining production checks

1. Replace the three shared enemy silhouettes and finalize boss art/attack readability.
